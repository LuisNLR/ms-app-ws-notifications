	...
	private void sendMailWithGMail(List<ResponseResumen> detailResumen) {
		...
		try {
			...
			String cuerpoHtml =
							...
							+ "      <p>Se hace de su conocimiento que tiene tramites en proceso y que han excedido el tiempo establecido.</p> \r\n"
							+ "      <p>La ubicación de los tramites que han excedido el tiempo de atención son las siguientes(s):</p> \r\n"
